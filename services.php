...
<section class="account-info-area section-padding">
    <div class="container">
        ...
        <div class="row g-2">
            <div class="col-md-5 col-lg-3 border p-4 mb-4 ">
                <div class="list-group corner-border" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action d-flex active" id="list-home-list"
            ...
            <div class="col-md-7 col-lg-9 border p-4 mb-4">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-home" role="tabpanel"
                        aria-labelledby="list-home-list">
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa, sapiente ex dolor ratione
