    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3  col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6>Payments</h6>
                    <p class="text-justify py-5 pr-5">
                        <a target="_blank" href="https://www.sslcommerz.com/" title="SSLCommerz" alt="SSLCommerz"><img
                                style="width:100%;height:auto;"
                                src="https://securepay.sslcommerz.com/public/image/sslcommerz.png" /></a>
                    </p>
                </div>
            </div>
            <div class="col-lg-3  col-md-6 col-sm-6">
...
<script src="https://cdn.tiny.cloud/1/bxclo4y02jr0vmd76mnxqbhenknmidfeb2byx9g57gt8b5sb/tinymce/6/tinymce.min.js"
    referrerpolicy="origin"></script>
<!-- <script src="js/jquery.nice-select.min.js"></script> -->
<!-- <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script> -->
<script src="<?php echo BASE_URL; ?>js/vendor/jquery-3.6.js"></script>
