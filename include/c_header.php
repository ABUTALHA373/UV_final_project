            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo BASE_URL; ?>admin/index.php">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo BASE_URL; ?>admin/admins.php">
                            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Admins</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo BASE_URL; ?>admin/users.php">
